...
export const REALISM_SCENARIOS: RealismScenarioSpec[] = [
  ...
  },
  {
    ...
    family: 'toxicology',
    match: ['opioid', 'overdose', 'naloxone', 'pinpoint', 'slow respir', 'bradypnea', 'hypoventilation', 'respiratory depression', 'unconscious'],
    priority: 90,
  ...
  },
  {
    ...
    family: 'metabolic',
    match: ['hypoglycemia', 'hypoglycaemia', 'diabetic', 'insulin', 'low bgl', 'low glucose', 'blood glucose', 'confused', 'seizure', 'post-ictal', 'postictal', 'missed meal', 'tremor'],
    priority: 70,
  ...
  },
  {
    ...
    family: 'cardiac',
    match: ['chest pain', 'acs', 'stemi', 'nstemi', 'angina', 'myocardial', 'diaphoresis', 'arrhythmia', 'svt', ' vt', ' vf', 'cardiac arrest'],
    priority: 65,
  ...
  },
  {
    ...
    family: 'burns',
    match: ['burn', 'thermal', 'chemical', 'electrical', 'scald', 'soot', 'smoke inhalation', 'singed hair', 'facial burn', 'airway burn'],
    priority: 75,
