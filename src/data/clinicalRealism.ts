...
// ============================================================================
// PHASE 6: ON-PATIENT REALISM CUE LAYER (merged from lib/patientRealism.ts)
// Visual/observable cue derivation + treatment-match realism feedback shown
// on the mannequin. Kept here so all clinical-realism logic lives in one
// module. Imports it needs (Treatment, inferInjuries, injuryRegionTo3D) are
