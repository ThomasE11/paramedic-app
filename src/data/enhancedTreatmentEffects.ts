...
export const TREATMENTS: Treatment[] = [
  ...
  },
  {
    id: 'ondansetron_4mg',
    name: 'Ondansetron 4mg IV',
    description: 'Antiemetic — for nausea/vomiting, aspiration risk reduction in low GCS',
    category: 'medication',
    onset: 'moderate',
    onsetTimeSeconds: 10,
    durationSeconds: 30,
    ...
    contraindications: ['Known long QT syndrome'],
  },
  {
  ...
  {
    id: 'txa_1g',
    name: 'Tranexamic Acid 1g IV',
    description: 'Antifibrinolytic — reduces bleeding in trauma. Give within 3 hours of injury (AHA/CRASH-2)',
    category: 'medication',
    onset: 'gradual',
    onsetTimeSeconds: 15,
    durationSeconds: 60,
    ...
    contraindications: ['>3 hours since injury', 'Active thromboembolic disease'],
  },
  {
    id: 'midazolam_5mg',
    name: 'Midazolam 5mg IV/IM',
    description: 'Benzodiazepine for seizures, sedation, anxiolysis',
    category: 'medication',
    onset: 'fast',
    onsetTimeSeconds: 3,
    durationSeconds: 30,
    ...
    contraindications: ['Respiratory depression', 'Severe COPD', 'Myasthenia gravis'],
  },
  {
