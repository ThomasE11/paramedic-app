...
export const asthmaSeverityCases: CaseScenario[] = [
  ...
  createCase({
    ...
    secondarySurvey: {
      ...
      chest: ['Bilateral wheeze on auscultation', 'Equal expansion', 'No chest wall tenderness'],
  ...
  createCase({
    ...
    secondarySurvey: {
      head: ['Normal'],
      neck: ['No JVD', 'Trachea midline'],
      chest: ['Severely diminished air entry bilaterally', 'Accessory muscle use', 'Intercostal recession'],
      abdomen: ['Soft, non-tender'],
      pelvis: ['Normal'],
      extremities: ['No peripheral oedema', 'Peripheral pulses present'],
      posterior: ['Normal'],
