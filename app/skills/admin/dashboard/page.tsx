  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      <div className="space-y-6 sm:space-y-8 p-4 sm:p-6 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
              <div className="flex items-center space-x-4 sm:space-x-6">
                <div className="relative flex-shrink-0">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-red-500 to-purple-600 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg">
                    <Shield className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8 text-white" />
                  </div>
                  <div className="absolute -inset-1 bg-gradient-to-r from-red-600 to-purple-600 rounded-xl sm:rounded-2xl blur opacity-30"></div>
                </div>
                <div className="min-w-0 flex-1">
                  <h1 className="text-2xl sm:text-3xl lg:text-4xl font-light text-slate-900 dark:text-white tracking-tight">Control Center</h1>
        ...
        <div className="bg-amber-50/80 dark:bg-amber-900/30 backdrop-blur-xl border border-amber-200/50 dark:border-amber-800/50 rounded-2xl p-4 sm:p-6 shadow-lg">
          <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0">
            <div className="w-10 h-10 bg-gradient-to-br from-amber-500 to-orange-500 rounded-xl flex items-center justify-center sm:mr-4 shadow-lg flex-shrink-0">
              <AlertCircle className="h-5 w-5 text-white" />
            </div>
            <div className="min-w-0 flex-1">
              <h3 className="text-base sm:text-lg font-semibold text-amber-800 dark:text-amber-200">Development Mode</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <div className="group relative">
            <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl rounded-xl sm:rounded-2xl border border-white/30 dark:border-slate-800/50 p-4 sm:p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center justify-between mb-3 sm:mb-4">
                ...
                <div className="text-right">
                  <div className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white">{stats.totalUsers}</div>
                </div>
              </div>
              <h3 className="text-xs sm:text-sm font-medium text-slate-600 dark:text-slate-300 uppercase tracking-wide">Total Users</h3>
            ...
            <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-xl sm:rounded-2xl blur opacity-20 group-hover:opacity-30 transition duration-300"></div>
          </div>
          ...
          <div className="group relative">
            <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl rounded-xl sm:rounded-2xl border border-white/30 dark:border-slate-800/50 p-4 sm:p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-xs sm:text-sm font-medium text-slate-600 dark:text-slate-300 uppercase tracking-wide">Skills Available</h3>
          ...
          <div className="group relative">
            <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl rounded-xl sm:rounded-2xl border border-white/30 dark:border-slate-800/50 p-4 sm:p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center justify-between mb-3 sm:mb-4">
                ...
                <div className="text-right">
                  <div className="text-2xl sm:text-3xl font-bold text-purple-600 dark:text-purple-400">{stats.totalProgress}</div>
                </div>
              </div>
              <h3 className="text-xs sm:text-sm font-medium text-slate-600 dark:text-slate-300 uppercase tracking-wide">Progress Records</h3>
          ...
          <div className="group relative">
            <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl rounded-xl sm:rounded-2xl border border-white/30 dark:border-slate-800/50 p-4 sm:p-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center justify-between mb-3 sm:mb-4">
                ...
                <div className="text-right">
                  <div className="text-2xl sm:text-3xl font-bold text-emerald-600 dark:text-emerald-400 capitalize">{stats.systemHealth}</div>
                </div>
              </div>
              <h3 className="text-xs sm:text-sm font-medium text-slate-600 dark:text-slate-300 uppercase tracking-wide">System Health</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Database: {stats.databaseStatus}</p>
            </div>
            <div className="absolute -inset-0.5 bg-gradient-to-r from-orange-600 to-red-600 rounded-xl sm:rounded-2xl blur opacity-20 group-hover:opacity-30 transition duration-300"></div>
          </div>
        </div>

        {/* Modern Development Authentication Info */}
        <div className="bg-blue-50/80 dark:bg-blue-900/30 backdrop-blur-xl border border-blue-200/50 dark:border-blue-800/50 rounded-2xl p-4 sm:p-6 shadow-xl">
          <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 mb-4 sm:mb-6">
            <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center sm:mr-3 shadow-lg flex-shrink-0">
              <Shield className="h-5 w-5 text-white" />
            </div>
            <div className="min-w-0 flex-1">
              <h3 className="text-base sm:text-lg font-semibold text-blue-800 dark:text-blue-200">Development Authentication</h3>
              <p className="text-xs sm:text-sm text-blue-700 dark:text-blue-300">Available test accounts for development and testing</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
          <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl rounded-xl sm:rounded-2xl border border-white/30 dark:border-slate-800/50 p-4 sm:p-6 shadow-xl hover:shadow-2xl transition-all duration-300">
            <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 mb-4 sm:mb-6">
              <div className="w-10 h-10 bg-gradient-to-br from-slate-500 to-slate-600 rounded-xl flex items-center justify-center sm:mr-3 shadow-lg flex-shrink-0">
                <Settings className="h-5 w-5 text-white" />
              </div>
              <div className="min-w-0 flex-1">
                <h3 className="text-base sm:text-lg font-semibold text-slate-900 dark:text-white">System Management</h3>
                <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Configure system settings and preferences</p>
              </div>
            </div>
          ...
          <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl rounded-xl sm:rounded-2xl border border-white/30 dark:border-slate-800/50 p-4 sm:p-6 shadow-xl hover:shadow-2xl transition-all duration-300">
            <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 mb-4 sm:mb-6">
              <div className="w-10 h-10 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center sm:mr-3 shadow-lg flex-shrink-0">
                <Users className="h-5 w-5 text-white" />
              </div>
              <div className="min-w-0 flex-1">
                <h3 className="text-base sm:text-lg font-semibold text-slate-900 dark:text-white">User Management</h3>
                <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Manage students, lecturers, and permissions</p>
              </div>
            </div>
            <div className="space-y-3">
          ...
          <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl rounded-xl sm:rounded-2xl border border-white/30 dark:border-slate-800/50 p-4 sm:p-6 shadow-xl hover:shadow-2xl transition-all duration-300">
            <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 mb-4 sm:mb-6">
              <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl flex items-center justify-center sm:mr-3 shadow-lg flex-shrink-0">
                <BookOpen className="h-5 w-5 text-white" />
              </div>
              <div className="min-w-0 flex-1">
                <h3 className="text-base sm:text-lg font-semibold text-slate-900 dark:text-white">Content Management</h3>
                <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Manage skills, categories, and learning content</p>
              </div>
            </div>
            <div className="space-y-3">
        ...
        <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl rounded-xl sm:rounded-2xl border border-white/30 dark:border-slate-800/50 p-4 sm:p-6 shadow-xl hover:shadow-2xl transition-all duration-300">
          <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 mb-4 sm:mb-6">
            <div className="w-10 h-10 bg-gradient-to-br from-orange-500 to-red-500 rounded-xl flex items-center justify-center sm:mr-3 shadow-lg flex-shrink-0">
              <Activity className="h-5 w-5 text-white" />
            </div>
            <div className="min-w-0 flex-1">
              <h3 className="text-base sm:text-lg font-semibold text-slate-900 dark:text-white">Test Different Views</h3>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Switch between different user role views for testing</p>
            </div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
