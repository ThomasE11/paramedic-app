...
export default function LecturerMessaging() {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const recipientId = selectedConversation.messages[0]?.fromRole === 'LECTURER' 
          ...
          <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-3xl border border-white/20 dark:border-slate-800/50 p-8 shadow-2xl">
            ...
            <div className="relative">
              ...
              <p className="text-slate-600 dark:text-slate-400 mt-3 text-lg">
                Communicate with students about their learning progress
              </p>
            </div>
          </div>
        </div>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center space-x-2">
                            ...
                            <Badge className="text-xs bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300 backdrop-blur-sm border border-green-200/30 dark:border-green-800/30">
            ...
            {selectedConversation ? (
                ...
                <div className="p-6">
                  <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
                    {selectedConversation.messages.map((message) => (
                      <div
                        key={message.id}
                        className={`flex ${message.fromRole === 'LECTURER' ? 'justify-end' : 'justify-start'}`}
                      >
                        <div
                        ...
                        >
                          ...
                          <div className={`text-xs mt-2 flex items-center ${
                            message.fromRole === 'LECTURER' ? 'text-blue-100' : 'text-slate-500 dark:text-slate-400'
                          }`}>
              ...
              <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-3xl border border-white/20 dark:border-slate-800/50 shadow-2xl">
                <div className="flex flex-col items-center justify-center py-16 px-8">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Select a student</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-center text-lg max-w-md">
                    Choose a student from the list to start viewing and sending messages
                  </p>
                </div>
              </div>
            )}
